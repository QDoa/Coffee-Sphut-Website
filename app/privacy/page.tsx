...
export default function Privacy() {
  return (
    <div className="items-center mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-6 sm:py-4">
      <h1 className="tex-center text-xxl font-bold tracking-tight text-card-foreground sm:text-xl lg:text-xxl">
        Privacy Policy
      </h1>
      <p>
        This privacy policy applies to the Coffee Sphut app (hereby referred to as "Application") for mobile devices 
        that was created by Coffee Sphut (hereby referred to as "Service Provider") as an Ad Supported service. This 
      ...
      <p>
        ...
        certain personally identifiable information, including but not limited to Email, First Name, Last Name, Phone 
        Number, Birthday, Address. The information that the Service Provider request will be retained by them and used 
      ...
      <ul className="list-disc list-inside">
        ...
        <li><a href="" target="_blank" rel="noopener noopenerer">SanityIO</a></li>
      </ul>
      </div>
      <br />
      <p>
      ...
      <p></p>
      <br />
      <h2 className="text-xl font-bold">Opt-Out Rights</h2>
      <p>
        You can stop all collection of information by the Application easily by uninstalling it. You may use the standard uninstall processes as may be available as part of your mobile device or via the mobile application marketplace or network.
      </p>
      <br />
      <h2 className="text-xl font-bold">Data Retention Policy</h2>
      <p>
        The Service Provider will retain User Provided data for as long as you use the Application. If you'd like them to delete User Provided Data that you have provided via the Application, please contact them at info@coffeesphut.com and they will respond in a reasonable time.
      </p>
      <br />
      ...
      <div>
        <br/>
        <p>
          The Application does not address anyone under the age of 13. The Service Provider does not knowingly collect personally identifiable information from children under 13 years of age. In the case the Service Provider discover that a child under 13 has provided personal information, the Service Provider will immediately delete this from their servers. If you are a parent or guardian and you are aware that your child has provided us with personal information, please contact the Service Provider (info@coffeesphut.com) so that they will be able to take the necessary actions.
        </p>
      </div>
      <br />
      ...
      <p>
        ...
        practices, please contact the Service Provider via email at info@coffeesphut.com.
      </p>
    </div>
  );
}
